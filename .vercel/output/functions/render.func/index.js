...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-ffea663d.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-ffea663d.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/stores-452b688a.js", "_app/immutable/chunks/singletons-1c1e8f83.js"];
    stylesheets = ["_app/immutable/assets/_layout-9abc5dde.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-42d4a25b.js";
    imports2 = ["_app/immutable/components/error.svelte-42d4a25b.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/stores-452b688a.js", "_app/immutable/chunks/singletons-1c1e8f83.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});

// .svelte-kit/output/server/chunks/user-card.js
var User_card;
var init_user_card = __esm({
  ".svelte-kit/output/server/chunks/user-card.js"() {
    init_chunks();
    User_card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { user } = $$props;
      if ($$props.user === void 0 && $$bindings.user && user !== void 0)
        $$bindings.user(user);
      return `
<div class="${"p-4 shadow-lg rounded-lg bg-secondary hover:ring-2 ring-blue duration-200 cursor-pointer active:scale-90"}"><figure><img${add_attribute("src", user.image, 0)} draggable="${"false"}"${add_attribute("alt", user.maidenName, 0)} decoding="${"async"}" class="${"rounded-lg shadow-md"}" loading="${"eager|lazy"}"></figure>
  ...
  <div class="${"flex flex-col gap-1 xl:text-sm lg:text-sm md:text-sm text-xs mt-4"}"><h2 class="${"font-medium text-base"}">${escape(user.firstName + " " + user.lastName)}</h2>
    <p class="${"opacity-80 break-words"}">${escape(user.email)}</p></div></div>`;
    });
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let users = [];
      return `<div class="${"grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4"}">${!users.length ? `${each([1, 2, 3, 4, 5, 6, 7, 8, 9], (i) => {
        return `<div class="${"bg-secondary p-4 shadow-lg rounded-lg flex flex-col gap-4 animate-pulse"}"><div class="${"bg-primary rounded-lg shadow-lg w-100 h-44 animate-pulse"}"></div>
        <div class="${"rounded-full w-full h-6 bg-primary shadow-lg animate-pulse"}"></div>
        <div class="${"rounded-full w-1/2 h-6 bg-primary shadow-lg animate-pulse"}"></div>
      </div>`;
      })}` : ``}
  ${each(users, (user) => {
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-e34b3ce7.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-e34b3ce7.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/user-card-739b624c.js", "_app/immutable/chunks/navigation-69304785.js", "_app/immutable/chunks/singletons-1c1e8f83.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/components/pages/about/_page.svelte-f39a2c63.js";
    imports4 = ["_app/immutable/components/pages/about/_page.svelte-f39a2c63.js", "_app/immutable/chunks/index-6bfebf77.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file5 = "_app/immutable/components/pages/blog/_page.svelte-1e64d2d4.js";
    imports5 = ["_app/immutable/components/pages/blog/_page.svelte-1e64d2d4.js", "_app/immutable/chunks/index-6bfebf77.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file6 = "_app/immutable/components/pages/users/_page.svelte-d968abe9.js";
    imports6 = ["_app/immutable/components/pages/users/_page.svelte-d968abe9.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/user-card-739b624c.js", "_app/immutable/chunks/navigation-69304785.js", "_app/immutable/chunks/singletons-1c1e8f83.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});
...
var init_page_svelte5 = __esm({
  ".svelte-kit/output/server/entries/pages/users/_id_/_page.svelte.js"() {
    ...
    Page5 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `${`<div class="${"flex flex-col xl:grid lg:grid md:grid sm:grid xl:grid-cols-8 lg:grid-cols-8 md:grid-cols-6 sm:grid-cols-8 gap-4 animate-pulse"}"><div class="${"xl:col-span-2 lg:col-span-2 md:col-span-3 sm:col-span-8"}"><div class="${"p-4 shadow-lg rounded-lg bg-secondary relative flex flex-col items-center gap-4"}"><div class="${"w-full h-44 bg-primary rounded-lg shadow-lg"}"></div>
        <div class="${"shadow-lg rounded-full bg-primary w-full h-6"}"></div>
        <div class="${"shadow-lg rounded-full bg-primary w-1/2 h-6"}"></div></div></div>
    <div class="${"col-span-3 sm:col-span-4 md:col-span-3"}"><div class="${"p-4 shadow-lg rounded-lg bg-secondary"}"><div class="${"w-32 h-6 rounded-full shadow-lg bg-primary"}"></div>
        <div class="${"flex flex-col gap-3 mt-8"}"><div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div></div></div></div>
    <div class="${"col-span-3 sm:col-span-4 md:col-span-3"}"><div class="${"p-4 shadow-lg rounded-lg bg-secondary"}"><div class="${"w-32 h-6 rounded-full shadow-lg bg-primary"}"></div>
        <div class="${"flex flex-col gap-3 mt-8"}"><div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div>
          <div class="${"bg-primary shadow-lg rounded-full w-full h-6"}"></div></div></div></div></div>`}`;
    });
  }
});
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    file7 = "_app/immutable/components/pages/users/_id_/_page.svelte-0ccd4e22.js";
    imports7 = ["_app/immutable/components/pages/users/_id_/_page.svelte-0ccd4e22.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/navigation-69304785.js", "_app/immutable/chunks/singletons-1c1e8f83.js", "_app/immutable/chunks/stores-452b688a.js"];
    stylesheets7 = [];
    fonts7 = [];
  }
});
...
var manifest = {
  ...
  _: {
    entry: { "file": "_app/immutable/start-8514650b.js", "imports": ["_app/immutable/start-8514650b.js", "_app/immutable/chunks/index-6bfebf77.js", "_app/immutable/chunks/singletons-1c1e8f83.js"], "stylesheets": [], "fonts": [] },
    nodes: [
